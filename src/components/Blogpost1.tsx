        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <hr />
              {/* Date/Time */}
              <p>โพสต์เมื่อวันที่ 18 ธันวาคม 2567 โดยกัลปังหา ยุวราช</p>
              <hr />
              {/* Post Content */}
              {/* Post Content */}
              ...
              <p>
                ...
                <ul className="ml-4" style={{ listStyleType: "lower-alpha" }}>
                  <li>
                    การกาหนดรูปแบบในการพัฒนาองค์การ
                    การกาหนดเป้าหมายและตัวชี้วัดให้ชัดเจน (KPI)
                  </li>
                  <li>มีแนวคิดเชิงบวกเกี่ยวกับองค์การ</li>
                  <li>ปรึกษาด้านการพัฒนาองค์การ</li>
                </ul>
              </p>
              <p className="lead">การพัฒนาองค์การคืออะไร </p>
              <p>
                OD: การพัฒนาองค์การ คือ
                <ul className="ml-4">
                  ...
                  <li>
                    ...
                    และสอดคล้องกับองค์ความรู้ด้านพฤติกรร(มศาสตร์ (Behavioral
                    Science)
                  </li>
                  <li>
              ...
              OD มีรากฐานมาจาก
              <ul style={{ listStyleType: "upper-roman" }}className="ml-4">
              ...
              <ul className="ml-4">
                ...
                <li>7. OD ต้องอาศัยความร่วมมือจากบุคคลต่าง ๆ</li>
                <li>
              ...
              <p>
                ...
                <ul className="ml-4">
                  <li>
                    เช่น เช่น ภาวะผู้นำ กระบวนการกลุ่ม การออกแบบงาน กลยุทธ์
              ...
              <p className="lead">
                การพัฒนา OD จะต้องอยู่บนรากฐานของความรู้และค่านิยม OD
              </p>
              ...
              <p>
                ...
                <p>
                  2.มาจากรากฐาน Action Research และ Survey Feedback
                  <ul className="ml-4">
                    <li></li>
                  </ul>
                </p>
